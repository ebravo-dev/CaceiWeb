<%@ Page Title="Materias" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="Materias.aspx.cs" Inherits="CaceiWeb.Admin.Materias" %>

    <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        <div class="page-header">
            <h1>📚 Gestión de Materias</h1>
            <div class="header-actions">
                <a href="ImportarMaterias.aspx" class="btn btn-secondary">📁 Importar CSV</a>
            </div>
        </div>
        ...
        <div class="card">
            <h3 class="card-title">
                <asp:Literal ID="litFormTitulo" runat="server">Nueva Materia</asp:Literal>
            </h3>
            ...
            <div class="form-row">
                <div class="form-group form-col">
                    ...
                    <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control"
                        placeholder="Ej: Programación Orientada a Objetos" MaxLength="150" />
                </div>
                <div class="form-group form-col-sm">
                    <label for="txtClave">Clave *</label>
                    <asp:TextBox ID="txtClave" runat="server" CssClass="form-control" placeholder="Ej: POO"
                        MaxLength="20" />
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="table-container">
                <asp:Repeater ID="rptMaterias" runat="server" OnItemCommand="rptMaterias_ItemCommand">
                    <HeaderTemplate>
